...
/**
 * Typed agent annotated with a customizer for testing customization hook.
 */
@AgenticService
public interface CustomizedGreeterAgent {

    @UserMessage("Say hello to {{name}}")
    @Agent(description = "Greets a person by name (customized)")
