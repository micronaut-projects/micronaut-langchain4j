...
public final class AgenticServiceInterceptor implements MethodInterceptor<Object, Object> {
    ...
    public static final String OUTPUT_KEY_MEMBER = "outputKey";
    ...
    private Object resolveAgent(AnnotationValue<AgenticService> annotation,
        ...
        var outputKey = annotation != null && annotation.contains(OUTPUT_KEY_MEMBER)
            ? annotation.stringValue(OUTPUT_KEY_MEMBER).orElse(null) : null;
